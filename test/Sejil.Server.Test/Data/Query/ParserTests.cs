...
namespace Sejil.Test.Data.Query
{
    ...
    public class ParserTests
    {
        ...
        {
            var ex = Assert.Throws<QueryEngineException>(() => new Parser(new Scanner("'v'=p").Scan(), Array.Empty<string>()).Parse());
        ...
        {
            var ex = Assert.Throws<QueryEngineException>(() => new Parser(new Scanner("p=p").Scan(), Array.Empty<string>()).Parse());
        ...
        {
            var ex = Assert.Throws<QueryEngineException>(() => new Parser(new Scanner(source).Scan(), Array.Empty<string>()).Parse());
